           ...
           <div class="title-div">
            ...
            <div class="sub-title-div">
                <h3 class="sub-title-hidden sub-title-2">
                    CNC Machine Prevention Maintenance
                </h3>
            </div>
            <div class="cnc_mpm_img_div">
                <img class="cnc_mpm_img" src="..\CNC_MPM3.jpeg">
            </div>
            <div >
                <p class="sub-text" style="margin-bottom:0px;">Preventive Maintenance Services for Cutting-Edge Machines:</p>
            </div>
            <div class="">
                   <div class="item-list-div-hidden ">
                    <div class="item-list-div" style="    margin-top: 42px;">
                        <ul>
                            <li>CNC DYNAMOTION</li>
                            <li>CNC PLURITEC GIGA</li>
                            <li>CNC BEAUTIFUL</li>
                            <li>CNC BETTER</li>
                            <li>CNC LENZ</li>
                            <li>CNC SOGOTEC</li>
                    ...
                    <div class="MPM2-img-div">
                      <img class="MPM2-img" src="..\CNC_MPM2.jpeg">
                     </div>
                  </div>
                 </div>
...
<div class="about-us"  id="aboutus" style="margin:0px;">
