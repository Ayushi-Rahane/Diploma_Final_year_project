<div>
    <div class="header">
        ...
        <div class="mid-header">
            <a href="mailto:m_rahane@yahoo.com" class="email"><i class="fa-solid fa-envelope"></i> m_rahane@yahoo.com</a>  <br> <br>
        ...
        <ul class="menu-ul">
            ...
            <li class="services">
                ...
                <ul class="service-drop-down-menu">
                    <li class="service-list special-link"><a class="service-list-link special-link" href="services\service_list\spindle_repair.php">Spindle Repair</a></li>
