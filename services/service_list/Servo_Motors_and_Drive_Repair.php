           ...
           <div class="title-div">
            ...
            <div class="sub-title-div">
                <h3 class="sub-title-hidden">
                    Servo Motors and Drive Repair
                </h3>
            </div>
            <div>
                <p class="sub-text">Repair services are available for all makes of servo motors and drives:</p>
            </div>
            <div class="service-item-div item-list-parent-div" style="display:flex">
                <div class="service-item1-div-hidden">
                   <div>
                    <img class="service-img" src="../../products/Servo_motors.jpg">
                   </div>
                   <div>
                    <div class="service-title-div"><p class="service-title">Servo Motors and Drive Repair</p></div>   
