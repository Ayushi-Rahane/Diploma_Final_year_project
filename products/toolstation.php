<html>
  ...
  <div>
           <div class="title-div">
            ...
            <div>
                <p class="sub-text">Following products of Tool Station is available:</p>
            </div>
            <div class="service-item-div item-list-parent-div">
                <div class="service-item1-div-hidden">
                   <div>
                    <img class="service-img" src="product2.png">
                   </div>
                   <div>
                    <div class="service-title-div"><p class="service-title">Tool Station</p></div>   
