<html>
      ...
      <div>
        <div class="header">
          ...
          <div class="right-header">
           <a href="..\index.php"  onclick="smoothScroll('contact-us')" class="contact-us-link">contact us</a>
          </div>
         </div>
           <div class="nav">
               <div class="left-div">
  ...
  <div>
           <div class="title-div">
            <h1 class="title-hidden" style="margin-top:222px; margin-bottom:0%;">Product</h1>
            </div>
            ...
            <div class="cnc_mbm_img_div">
                <img class="cnc_mbm_img" src="CNC_DARM.jpeg">
            </div>
            <div>
                <p class="product-sub-text">Description:</p>
            </div>
            <div class="service-item-div item-list-parent-div" style="display:flex">
                   <div class="service-item2-div-hidden ">
                    <div class="item-list-div item-list-div2">
                        <ul>
                            
<li><span style="color:rgb(12, 100, 100)">Machine Model:</span>K I-SR2</li>
<li><span style="color:rgb(12, 100, 100)">Spindle Number:</span>2</li>
<li><span style="color:rgb(12, 100, 100)">Z Axis Servo Motor Number:</span>2</li>
<li><span style="color:rgb(12, 100, 100)">Servo Motor Brand:</span>Delta(X/Y/Z 750W)</li>
<li><span style="color:rgb(12, 100, 100)">Working Range per Spindle:</span>560*680mm</li>
<li><span style="color:rgb(12, 100, 100)">X/Y/Z moving range:</span>570/800/60mm</li>
<li><span style="color:rgb(12, 100, 100)">Tool Change:</span>Automatic Tool Change</li>
<li><span style="color:rgb(12, 100, 100)">Tool Post Number:</span>10/Spindle</li>
<li><span style="color:rgb(12, 100, 100)">Spindle:</span>DAKE 1.8KW.6000RMP Ball Bearing Spindle</li>
<li><span style="color:rgb(12, 100, 100)">Invertor:</span>Delta(Original Taiwan)</li>
<li><span style="color:rgb(12, 100, 100)">Routing Bit Size:</span>0.8~3.175mm</li>
<li><span style="color:rgb(12, 100, 100)">Control System:</span>English CNC Routing System</li>
<li><span style="color:rgb(12, 100, 100)">Controller:</span>Googletech-GTS400</li>
<li><span style="color:rgb(12, 100, 100)">X/Y Moving Speed:</span>30m/min</li>
<li><span style="color:rgb(12, 100, 100)">Positioning Accuracy:</span>±0.01mm</li>
<li><span style="color:rgb(12, 100, 100)">Repeat Accuracy:</span>±0.005mm</li>
<li><span style="color:rgb(12, 100, 100)">Drilling Format:</span>Excellon, WK, Protel, S&M1000/300/5000,TXT.NC.ROU.</li>
<li><span style="color:rgb(12, 100, 100)">Tool Length Detector:</span>Yes</li>
<li><span style="color:rgb(12, 100, 100)">Machine Dimension:</span>L2200*W1900*H1800mm</li>
<li><span style="color:rgb(12, 100, 100)">Machine Weight:</span>2500Kg</li>
                         </ul>
                    </div>
                    <div class="service-img-div">
                      <img class="product-img" src="CNC_DARM.jpeg">
                     </div>
                  </div>
                 </div>
