<html>
  ...
  <div>
           <div class="title-div">
            ...
            <div>
                <p class="sub-text">Following products of Servo Motors and Drivers are available:</p>
            </div>
            <div class="service-item-div item-list-parent-div" style="display:flex">
                <div class="service-item1-div-hidden">
                   ...
                   <div>
                    <div class="service-title-div"><p class="service-title">Servo Motors and Drive</p></div>   
